...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style type="text/css">
        ...
        margin: 0 8px 8px 0; /* 設置選項文字的左右和下方間隔 */
        }
    </style>
        ...
        <ContentTemplate>
            ...
            <table class="PopTable">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:CheckBoxList ID="cblEquipment" runat="server" RepeatDirection="Horizontal" RepeatColumns="5" CellSpacing="4" CssClass="checkbox-list"></asp:CheckBoxList>
                    </td>
                </tr>
            </table>
