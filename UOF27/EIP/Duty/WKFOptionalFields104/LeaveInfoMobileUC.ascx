                    ...
                    <table style="width: 100%">
                        <tr>
                            <td>
                                ...
                                <asp:DropDownList ID="ddlLeaveCode" Width="99%" AutoPostBack="True" runat="server" EnableTheming="True" meta:resourcekey="ddlLeaveCodeResource1" OnSelectedIndexChanged="ddlLeaveCode_SelectedIndexChanged">
                                </asp:DropDownList>
...
<asp:Label ID="lblCallDLLFail" runat="server" Text="呼叫DLL元件失敗" Style="display: none" meta:resourcekey="lblCallDLLFailResource1"></asp:Label>
