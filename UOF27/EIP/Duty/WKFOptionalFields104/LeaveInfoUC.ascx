                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <asp:DropDownList ID="ddlLeaveCode" runat="server" AutoPostBack="True" CausesValidation="False" meta:resourcekey="ddlLeaveCodeResource1" OnSelectedIndexChanged="ddlLeaveCode_SelectedIndexChanged">
                                </asp:DropDownList>
