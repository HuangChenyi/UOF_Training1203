...
<telerik:RadScriptBlock runat="server">
    ...
    function cvCheckTwoDate(source, args) {
        ...
        var rbOff = $('#<%=rbCloseDate.ClientID %>');
        var messagedate;
        var validator = $('#<%= cvCheckOffDate.ClientID %>');
        ...
        if ($('#<%=hfBullStatus.ClientID %>').val() == 'Publish' && rbPublishNow.prop("checked")) {
            publicdate = $('#<%=hfPublishDate.ClientID %>').val();
                var hourminute = $('#<%=hfPublishHourMinute.ClientID %>').val();
            publictime = $('#<%=hfPublishTime.ClientID %>').val();
            //args.IsValid = true;
...
<asp:HiddenField ID="hfBullStatus" runat="server" />
<asp:HiddenField ID="hfPublishDate" runat="server" />
<asp:HiddenField ID="hfPublishTime" runat="server" />
<asp:HiddenField ID="hfPublishHourMinute" runat="server" />
