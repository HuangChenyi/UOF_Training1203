...
<body style="background-color: black; vertical-align: middle;">
    <div id="content" style="vertical-align: central;">
          ...
          $('#divMovieeErr').height($('#content').height());
            ...
            <div>
                ...
                <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic"
                    ErrorMessage="無此影音觀看權限或影音已被刪除" Visible="False"
        ...
        <center>
            <table id="divMovieeErr" style="margin: 0 auto">
                <tr>
                    <td style="vertical-align: middle;">
                        <asp:Label ID="lblShowMovieErr" Font-Bold="true" Font-Size="Large" ForeColor="White" runat="server" Text="您所使用的瀏覽器無法觀看此影片，請使用其他瀏覽器觀看"
                            meta:resourcekey="lblShowMovieErrResource1"></asp:Label>
                        <br />
                        <center>
                            <asp:Image ID="Image1" ImageUrl="~/Common/UImages/notplay.png" runat="server"></asp:Image>
                        </center>
                    </td>
                </tr>
            </table>
