    ...
    <table>
        ...
        <td>
            ...
            <table class="SizeMemo">
                <tr>
                    <td>
                        <asp:Label ID="Label35" runat="server" Text="備註" ForeColor="Blue" meta:resourcekey="Label35Resource1"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblMp4Limit" runat="server" Text="1.MP4編碼Code須為H.264才能正常播放" ForeColor="Blue" meta:resourcekey="lblMp4LimitResource1"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblSizeLimit" runat="server" Text="2.檔案大小不允許超過 {0} MB"  ForeColor="Blue" meta:resourcekey="lblSizeLimitResource1"></asp:Label>
                    </td>
                </tr>
            </table>                        
        </td>
