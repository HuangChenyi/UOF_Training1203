...
<table width="100%" class="PopTable" cellspacing="1">
    <tr>
        ...
        <td>
            ...
            <telerik:RadButton ID="btnChangePW2" Text="變更密碼" runat="server" meta:resourcekey="btnChangePW2Resource1" style="position: relative;"></telerik:RadButton>
                   
            <asp:Panel id="pnlLastPasswordChangedDateTitle" runat="server">
                <br />
                <asp:label id="lblLastPasswordChangedDateTitle" runat="server" text="上次密碼變更日期" meta:resourcekey="lblLastPasswordChangedDateResource1"></asp:label>
            </asp:Panel>
            <asp:Panel id="pnlUOFPassword" runat="server">
                <asp:label id="lblUOFPasswordTitle" runat="server" text="UOF："></asp:label>
                <asp:label id="lblUOFLastPasswordChangedDate" runat="server"></asp:label>
            </asp:Panel>
            <asp:Panel id="pnlADPassword" runat="server">
                <asp:label id="lblADPasswordTitle" runat="server" text="AD："></asp:label>
                <asp:label id="lblADLastPasswordChangedDate" runat="server"></asp:label>
            </asp:Panel>
        </td>
        <td style="white-space: nowrap">
...
<asp:Label ID="lblADPasswordIsTimeoutMessage" runat="server" Text="無法取得密碼變更資訊" Visible="False" meta:resourcekey="lblADPasswordIsTimeoutMessageResource1"></asp:Label>
