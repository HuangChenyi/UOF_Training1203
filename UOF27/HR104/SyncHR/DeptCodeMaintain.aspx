            ...
            <table class="PopTable" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="lblCompanyCodeDisable" runat="server" ForeColor="Blue" Text="集團/公司層部門代碼不可修改，請依104設定為主"  Visible="false" meta:resourcekey="lblCompanyCodeDisableResource1"></asp:Label>
                        <asp:Label ID="lblCompanyCodeNotExist" runat="server" ForeColor="Blue" Text="此公司層設定的部門代碼不存在104系統，若欲同步此公司，請輸入與104系統相同的公司代碼。" Visible="False" meta:resourcekey="lblCompanyCodeNotExistResource1"></asp:Label>
                        <asp:CustomValidator ID="cvCompanyCodeNotExist" runat="server" ErrorMessage="公司別代碼不存在，請依104設定重新維護" Display="Dynamic" meta:resourcekey="cvCompanyCodeNotExistResource1" ></asp:CustomValidator>
