                    ...
                    <table style="width: 100%; height: 100%;">
                        ...
                        <tr>
                            <td style="padding-left: 5px;">
                                ...
                                <br />
                                <asp:Label ID="lblUOFIPMemo3" runat="server" Text="3.除特殊人員外，系統管理員(admin)也不受登入IP限制。" ForeColor="Blue" meta:resourcekey="lblUOFIPMemo3Resource1"></asp:Label>                            
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
                    ...
                    <table style="width: 100%; height: 100%;">
                        ...
                        <tr>
                            <td style="padding-left: 5px;">
                                ...
                                <br />
                                <asp:Label ID="lblAppIPMemo3" runat="server" Text="3.除特殊人員外，系統管理員(admin)也不受登入IP限制。" ForeColor="Blue" meta:resourcekey="lblAppIPMemo3Resource1"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
