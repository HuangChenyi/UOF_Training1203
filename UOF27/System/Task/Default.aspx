...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" EnableViewState="False">
            ...
            <telerik:RadPageView runat="server" Height="700px" ID="RadPageView3" BackColor="#ffffff">
                <div style="margin: 2px">
                    ...
                    <telerik:RadGrid ID="docQueueGrid" EnableViewState="false" runat="server" GridLines="Both" Width="100%"  AllowPaging="true" PageSize="15">
                        <ItemStyle Wrap="false"></ItemStyle>
                        <MasterTableView>
                            <Columns>
                                <telerik:GridBoundColumn UniqueName="TypeName" DataField="TypeName" HeaderText="工作" meta:resourcekey="GridBoundColumnResource3">
                        ...
                        <ClientSettings>
                            <ClientEvents OnCommand="QueueDocGrid_Command" OnRowDataBound="grid_RowDataBound"></ClientEvents>
                        </ClientSettings>
                    </telerik:RadGrid>
                </div>
                <div style="margin: 2px">
                ...
                <div style="margin: 2px; clear: both">
                    ...
                    <telerik:RadGrid ID="docHistoryGrid" EnableViewState="false" runat="server" GridLines="Both" AllowPaging="true" PageSize="15">
                        <ItemStyle Wrap="false"></ItemStyle>
                        <%--    <ClientSettings>
                <Scrolling AllowScroll="True" UseStaticHeaders="True" SaveScrollPosition="true" ></Scrolling>
                        ...
                        <ClientSettings>
                            <ClientEvents OnCommand="DocHistoryGrid_Command" OnRowDataBound="grid_RowDataBound"></ClientEvents>
                        </ClientSettings>
                    </telerik:RadGrid>
                </div>
            </telerik:RadPageView>
    ...
    <script type="text/javascript">
        ...
        function bindGrid() {
            ...
            $uof.pageMethod.async("GetDocJobByPage", ["queue", 0, 15], updateDocQueueGrid);
            $uof.pageMethod.async("GetDocJob", ["executing"], updateDocExecutingGrid);
            $uof.pageMethod.async("GetDocJobByPage", ["history", 0, 15], updateDocHistoryGrid);
            setTimeout(function () {
        ...
        function QueueDocGrid_Command(sender, args) {
            args.set_cancel(true);
            ...
            $uof.pageMethod.async("GetDocJobByPage", ["queue", currentPageIndex, pageSize], updateDocQueueGrid);
        }
        ...
        function DocHistoryGrid_Command(sender, args) {
            args.set_cancel(true);
            ...
            $uof.pageMethod.async("GetDocJobByPage", ["history", currentPageIndex, pageSize], updateDocHistoryGrid);
        }
        ...
        function updateDocQueueGrid(result) {
            ...
            var data = $uof.json.toObject(result);
             ...
             if (data.length > 0) {
                 docQueuecount = data[0]['ItemCount'];
             }
            var tableView = $find("<%= docQueueGrid.ClientID %>").get_masterTableView();
            tableView.set_dataSource(data);
            tableView.dataBind();
            tableView.set_virtualItemCount(docQueuecount);
        }
        ...
        function updateDocHistoryGrid(result) {
            ...
            var data = $uof.json.toObject(result);
            if (data.length > 0) {
                docHistorycount = data[0]['ItemCount'];
            }

            var tableView = $find("<%= docHistoryGrid.ClientID %>").get_masterTableView();
            tableView.set_dataSource(data);
            tableView.dataBind();
            tableView.set_virtualItemCount(docHistorycount);
        }
