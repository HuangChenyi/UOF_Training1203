        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txbSender" runat="server" MaxLength="300" 
                    meta:resourcekey="txbSenderResource1" Columns="50">
                </asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txbSender"
                    ErrorMessage="寄件人不允許為空白" Display="Dynamic" meta:resourcekey="RequiredFieldValidator4Resource1">
                </asp:RequiredFieldValidator>
                <asp:CustomValidator ID="cvSenderEmailFormat" runat="server" OnServerValidate="cvSenderEmailFormat_ServerValidate"
                    Display="Dynamic" ErrorMessage="請輸入正確的Email格式" meta:resourcekey="RegularExpressionValidator1Resource1">
                </asp:CustomValidator>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:CustomValidator ID="cvReceiverEmailFormat" runat="server" OnServerValidate="cvReceiverEmailFormat_ServerValidate"
                    Display="Dynamic" ErrorMessage="請輸入正確的Email格式" meta:resourcekey="RegularExpressionValidator1Resource1">
                </asp:CustomValidator>
            </td>
        </tr>
