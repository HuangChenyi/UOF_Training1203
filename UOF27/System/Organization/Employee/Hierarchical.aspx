            ...
            <Fast:Grid ID="Grid1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="網域" SortExpression="DOMAIN_NICKNAME" meta:resourceKey="DomainTemplateFieldResource1">
                     ...
                     <asp:TemplateField HeaderText="AD帳號" meta:resourceKey="TemplateFieldResource6" SortExpression="ACCOUNT_MAPPING">
                        <ItemTemplate>
                            <asp:Label ID="lblDisplayAccountMapping" runat="server" meta:resourceKey="lblDisplayAccountMappingResource1" Text='<%# Bind("ACCOUNT_MAPPING") %>'></asp:Label>
                        </ItemTemplate>
                         <HeaderStyle Wrap="False" />
                        <ItemStyle Wrap="False" />
                    </asp:TemplateField>
