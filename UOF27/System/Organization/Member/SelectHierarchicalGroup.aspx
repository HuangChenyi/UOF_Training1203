...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <telerik:RadTreeView ID="RadTreeView1" runat="server" Height="400px" Width="200px" meta:resourcekey="RadTreeView1Resource1" EnableNodeTextHtmlEncoding="true"></telerik:RadTreeView>
        </ContentTemplate>
    </asp:UpdatePanel>
