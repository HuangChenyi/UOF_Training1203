...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="lblToday"  runat="server" Text="今日天氣 (資料來源：台灣中央氣象署RSS)" Visible="False" meta:resourcekey="lblApplyResource1"></asp:Label>
    <asp:Label ID="lblFuture" runat="server" Text="未來一周天氣 (資料來源：台灣中央氣象署RSS)" Visible="False" meta:resourcekey="lblFutureResource1"></asp:Label>
</asp:Content>
