                    ...
                    <table align="center" width="572px" border="0" cellpadding="0" cellspacing="1" id="TABLE1" runat="server" class="PopTable">
                        <tr>
                            <td align="center" class="GridHeader" style="height: 20px; text-align: center;">
                                <asp:Label ID="LabelTitle" runat="server" meta:resourcekey="LabelTitleResource1" Text="條件式站點" ForeColor="Black"></asp:Label></td>
                        </tr>
                        <tr>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FlowId" Visible="False" meta:resourcekey="TemplateFieldResource1">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label runat="server" Text='<%#: Bind("CondName") %>' ID="LabelCondName" meta:resourceKey="LabelFlowIdResource1" __designer:wfdid="w10"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
