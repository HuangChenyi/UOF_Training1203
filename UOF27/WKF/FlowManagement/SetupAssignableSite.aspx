           ...
           <td style="height: 27px; width: 20%;" class="PopTableLeftTD">
            ...
            <td style="height: 27px" class="PopTableRightTD">
                ...
                <div id="divCycleNotifySite" style="padding-left:15px;">
                    <telerik:RadNumericTextBox ID="txtCycleHour" runat="server" Width="60px" MinValue="0" MaxValue="9999" MaxLength="4" Value="0" DataType="System.String" Culture="zh-TW" DbValueFactor="1" LabelWidth="24px" meta:resourcekey="txtCycleHourResource1">
                        <NumberFormat ZeroPattern="n" AllowRounding="False" DecimalDigits="0"  ></NumberFormat>
                    </telerik:RadNumericTextBox>
