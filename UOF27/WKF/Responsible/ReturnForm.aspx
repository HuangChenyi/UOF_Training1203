...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        <table width="100%" class="PopTable" cellspacing="1">
            <tr>
                <td class="PopTableHeader" align="center" style="height: 25px">
                    <asp:Label ID="lblTitleA" runat="server" Text="表單結案復原" meta:resourcekey="lblTitleAResource1"></asp:Label>
                </td> 
            </tr>
            <tr>
                <td style="text-align:center; height: 100%;" class="PopTableRightTD" nowrap="nowrap">
                    <asp:Label ID="lblReturnFormMsg" runat="server" Text="此單為起單即為結案，無法復原！" ForeColor="Red" Visible="false" meta:resourcekey="lblReturnFormMsgResource1"></asp:Label>
                    <asp:Label ID="lblReturnFormMsgForReturnToApplicant" runat="server" Text="此單為退回申請者後作廢，無法復原！" ForeColor="Red" Visible="false" meta:resourcekey="lblReturnFormMsgForReturnToApplicantResource1"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
