...
<div style="text-align: center">
                                ...
                                <tr>
                                    <td align="right">
                                        <telerik:RadButton ID="WebImageButton_UPSite" runat="server"
                                            ...
                                            Text="↑" Width="20px" OnClick="WebImageButton_UPSite_Click1">
                                        </telerik:RadButton>
                                        <telerik:RadButton ID="WebImageButton_DownSite" runat="server"
                                            meta:resourcekey="WebImageButton_DownSiteResource1"
                                            Text="↓" Width="20px" OnClick="WebImageButton_DownSite_Click1">
                                        </telerik:RadButton>
    ...
    <asp:Label ID="lblModifyCustSiteMsg" runat="server" Text="維護使用者自訂站點" Visible="False" meta:resourcekey="lblModifyCustSiteMsgResource1"></asp:Label>
    <asp:Label ID="lblInheritForm" runat="server" Text="繼承表單" Visible="False" meta:resourcekey="lblInheritFormResource1"></asp:Label>
</div>
