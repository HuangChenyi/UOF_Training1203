...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="text-align: center;">
        ...
        <asp:Label ID="lblConfirmMsg" runat="server" Text="請選擇自訂流程" Visible="False" meta:resourcekey="lblConfirmMsgResource1"></asp:Label></div>
         ...
         <asp:Label ID="lblNotInLimitSigner" runat="server" Text="此表單有限定可加簽的對象，所選人員不在可加簽範圍內 ，如需調整請洽表單管理員!" Visible="false" meta:resourcekey="lblNotInLimitSignerResource1" ></asp:Label>
</asp:Content>
