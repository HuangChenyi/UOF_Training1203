        ...
        <ContentTemplate>
            <table width=100% class = "PopTable" cellspacing="1">
                <tr>
                    ...
                    <center>
                        <asp:Label ID="Label1" runat="server" Text="新增網址" meta:resourcekey="Label1Resource1"></asp:Label>
                    </center>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class = "PopTableRightTD" style="height: 26px">
                        <asp:TextBox ID="txtUrl" runat="server" Width="450px" meta:resourcekey="txtUrlResource1" MaxLength="200"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class = "PopTableLeftTD" style="height: 26px" nowrap="noWrap">
