...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table width=100% class = "PopTable" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class = "PopTableRightTD" style="height: 26px">
                        <asp:TextBox ID="txtWsName" runat="server" Width="450px" meta:resourcekey="txtWsNameResource1"></asp:TextBox>
                    </td>
                </tr>
                            <tr>
                    <td class = "PopTableLeftTD" style="height: 26px" nowrap="noWrap" >
                        <asp:Label ID="Label7" runat="server" Text="網址" meta:resourcekey="Label7Resource1"></asp:Label>
                    </td>
                    <td class = "PopTableRightTD" style="height: 26px">
                        <asp:TextBox ID="txtUrl" runat="server" Width="450px" meta:resourcekey="txtUrlResource1"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class = "PopTableLeftTD" style="height: 26px" nowrap="noWrap">
                        <asp:Label ID="Label3" runat="server" Text="呼叫的方法" meta:resourcekey="Label3Resource1"></asp:Label>
                    </td>
                    <td class = "PopTableRightTD" style="height: 26px">
                        <asp:TextBox ID="txtWsMethod" runat="server" Width="450px" meta:resourcekey="txtWsMethodResource1"></asp:TextBox>
                    </td>
            </table>
            <table width = 100%>
                <tr>
    ...
    <asp:Label ID="lblNameRepeat" runat="server" Text="名稱不能重複" Visible="False" meta:resourcekey="lblNameRepeatResource1"></asp:Label>          
