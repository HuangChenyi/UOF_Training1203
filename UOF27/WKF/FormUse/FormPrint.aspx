    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            Sys.Application.add_load(function () {
                ...
                $(".tdTypeDesc").css('background-color', 'white');

                initDetailFieldDisplay();
            });
            ...
            //初始設定是否勾選明細欄位資料直向顯示
            function initDetailFieldDisplay() {

                switch ($("#hfPrintDetailFieldMode").val()) {

                    case 'Force':
                        $(".trDataGridHorizontal").hide();
                        $(".trDataGridVertical").show();
                        break;

                    case 'Custom':
                        switch ($("#hfPrintDetailFieldDirectionMode").val()) {
                            ...
                            case 'Horizontal':
                                $(".trDataGridVertical").hide();
                                $(".trDataGridHorizontal").show();
                                break;
            ...
            //明細欄位資料直向顯示勾選事件
            function oncbDetailFieldDisplayVerticalClick() {

                if ($('#<%=cbDetailFieldDisplayVertical.ClientID %>').is(':checked')) {
                    $(".trDataGridVertical").show();
                    $(".trDataGridHorizontal").hide();
                }
                else {
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <asp:Label ID="lblNoAuthMessage" runat="server" ForeColor="Red" Text="*無此表單列印權限" meta:resourcekey="lblNoAuthMessageResource1"></asp:Label></td>
                                <td width="18"></td>
                            </tr>
                            <tr>
                                <td style="width: 19px">&nbsp;</td>
                                                                ...
                                                                <tr id="PrintStatus">
                                                                    <td align="right" colspan="6">
                                                                        <asp:Panel ID="PrintInfo" runat="server" meta:resourcekey="PrintInfoResource1">
                                                                            ...
                                                                            <asp:CheckBox ID="cbComment" runat="server" Checked="True" onclick="commentClick();"
                                                                                Text="顯示簽核意見" meta:resourcekey="cbCommentResource1" />

                                                                            <asp:CheckBox ID="cbSignature" runat="server" Checked="True" onclick="signClick();" 
                                                                                Text="顯示電子簽章" meta:resourcekey="cbSignatureResource1" />
                                                                            ...
                                                                            <asp:CheckBox ID="cbDetailFieldDisplayVertical" runat="server" onclick="oncbDetailFieldDisplayVerticalClick()" Visible="false"
                                                                                Text="明細欄位資料直向顯示" meta:resourcekey="cbDetailFieldDisplayVerticalResource1" />
        ...
        <asp:HiddenField ID="hfPrintDetailFieldMode" runat="server" />
        <asp:HiddenField ID="hfPrintDetailFieldDirectionMode" runat="server" />
