...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="AdditionalSignSendjs" type="text/javascript">
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "ReturnForm") {
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/Custom/SelectCustSite.aspx", args.get_item(), args.get_item().get_text(), 1280, 1080, openDialogResult, { "custSiteId": custSiteId, "formVersionId": formVersionId, "isFromPreAdditional": true });
            }
        }
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" OnButtonClick="RadToolBar1_ButtonClick" OnClientButtonClicking="RadToolBar1_ButtonClicking" Width="100%" meta:resourcekey="RadToolBar1Resource1" SingleClick="None">
        <Items>
            ...
            <telerik:RadToolBarButton runat="server" ImageUrl="~/Common/Images/Icon/icon_m101.gif" Value="CustSite" HoveredImageUrl="~/Common/Images/Icon/icon_m101.gif" Visible="False" CheckedImageUrl="~/Common/Images/Icon/icon_m101.gif" Text="加簽副流程" meta:resourceKey="TBarButtonResource2" DisabledImageUrl="~/Common/Images/Icon/icon_m101.gif">
            </telerik:RadToolBarButton>
    ...
    <asp:Panel ID="PanelNextSite" runat="server" Width="100%" meta:resourcekey="PanelNextSiteResource1" CssClass="panelDiv">
        ...
        <tr>
            ...
            <td>
                <telerik:RadNumericTextBox ID="txtCycleAlert" runat="server" Width="60px" MinValue="0" MaxValue="9999" MaxLength="4" Value="0" DataType="System.String" Culture="zh-TW" DbValueFactor="1" LabelCssClass="" LabelWidth="64px" meta:resourcekey="txtCycleAlertResource1">
                    <NegativeStyle Resize="None" />
                    <NumberFormat ZeroPattern="n" AllowRounding="False" DecimalDigits="0"  ></NumberFormat>
                    <EmptyMessageStyle Resize="None" />
                    <ReadOnlyStyle Resize="None" />
                ...
                <asp:Label ID="Label6" runat="server" Text="[0表示不提醒]" CssClass="SizeMemo" meta:resourcekey="Label6Resource1"></asp:Label>
