...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="FirstSitejs" type="text/javascript">
        ...
        function cvScriptNameValidation(sender, args) {

            let tbxScriptName = $('#<%=tbxScriptName.ClientID %>').val();

            if (tbxScriptName.trim() === "") {
                args.IsValid = false;
            }
            else {
                args.IsValid = true;
                                                            ...
                                                            <table style="text-align:right;width:100%">
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:CustomValidator ID="cvScriptName" runat="server" ErrorMessage="請輸入草稿名稱" Display="Dynamic" ClientValidationFunction="cvScriptNameValidation" meta:resourcekey="RequiredFieldValidatorScriptNameResource1"></asp:CustomValidator>                                                                        
