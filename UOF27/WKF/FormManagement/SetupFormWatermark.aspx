                ...
                <td colspan="2" style="background-color: #ffffff;width: 50%">
                    ...
                    <div id="txtSetting">
                        <table cellpadding="1" cellspacing="1" style="height: 100%" class="tab2">
                            ...
                            <tr>
                                <td style="background-color: #cccccc" align="right">
                                    <asp:Label runat="server" Text="不透明度：" ID="Label14" meta:resourcekey="Label14Resource1"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlTransparency1" runat="server" meta:resourcekey="ddlTransparency1Resource1" >
                                        ...
                                        <asp:ListItem meta:resourcekey="ListItemResource44">80</asp:ListItem>
                                        <asp:ListItem meta:resourcekey="ListItemResource45" >90</asp:ListItem>
                                        <asp:ListItem  Selected="True" meta:resourcekey="ListItemResource46" >100</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                ...
                <td style="background-color: #ffffff;width: 50%" colspan="2">
                    <div id="txtSetting2">
                        <table cellpadding="1" cellspacing="1" style="height: 100%" class="tab2">
                            ...
                            <tr>
                                <td style="background-color: #cccccc" align="right">
                                    <asp:Label runat="server" Text="不透明度：" ID="Label15" meta:resourcekey="Label15Resource1"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlTransparency2" runat="server" meta:resourcekey="ddlTransparency2Resource1" >
                                        ...
                                        <asp:ListItem meta:resourcekey="ListItemResource96">80</asp:ListItem>
                                        <asp:ListItem meta:resourcekey="ListItemResource97" >90</asp:ListItem>
                                        <asp:ListItem  Selected="True" meta:resourcekey="ListItemResource98" >100</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
