    ...
    <script type="text/javascript" id="telerikClientEvents1">
        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "AddConditionBase") {//新增判斷式
                ...
                $uof.dialog.open2("~/WKF/FormManagement/ManageFormConditionBase.aspx", args.get_item(), '<%=lblAddConditionBaseBtnValue.Text%>', 1200, 500, openDialogResult,
                    {
                        "FormCondition": "Y",
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/FormManagement/ManageFormCondition.aspx", args.get_item(), '<%=lblAddConditionBtnValue.Text%>', 1000, 500, openDialogResult, { "formVersionId": formVersionId });
            }
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/ExternalModule/SortCondition.aspx", args.get_item(), '<%=lblSortConditionBtnValue.Text%>', 0, 0, openDialogResult, { "formVersionId": formVersionId });
            } else if (value == "Culture") {
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/FormManagement/MaintainCondAbbreviationCulture.aspx", args.get_item(), '<%=lblCultureBtnValue.Text%>', 0, 0, openDialogResult, { "formVersionId": formVersionId });
            } else if (value == "ImportCond") {
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/FormManagement/ImportCond.aspx", args.get_item(), '<%=lblImportCondBtnValue.Text%>', 500, 500, openDialogResult, { "formVersionId": formVersionId });
            }
        }
                    ...
                    <td style="height: 149px" valign="top">
                        <Fast:Grid ID="Grid1" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="簡稱" meta:resourceKey="TemplateFieldResource3">
