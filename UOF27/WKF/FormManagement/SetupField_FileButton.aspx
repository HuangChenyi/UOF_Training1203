            ...
            <td colspan="3">
                ...
                <div id="divRestricts">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblRestrict1" runat="server" Text="1.支援文件格式：doc, docx, txt, ppt, pptx, xls, xlsx, jpg, jpeg, png, bmp, gif, pdf。" CssClass="SizeMemo" meta:resourcekey="lblRestrict1Resource1"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div id="divThumbnailRestricts">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblThumbnailRestrict1" runat="server" Text="1.支援文件格式：jpg, jpeg, png, bmp, gif。" CssClass="SizeMemo"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
