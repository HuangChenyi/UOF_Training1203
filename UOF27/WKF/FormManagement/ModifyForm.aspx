...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SetControls() {
            ...
            CheckUOFChoiceDiv();
            CheckAppChoiceDiv();
            CheckPrintDefailFieldChoice($("#<%=cbAllowUserCustomPrintDetailFieldWithVertical.ClientID%>")[0]);
        }
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="2" meta:resourcekey="RadMultiPage1Resource1">
            ...
            <table cellspacing="1" class="PopTable" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="3" nowrap class="PopTableRightTD">
                        <telerik:RadNumericTextBox ID="rNumCycleHours" DataType="System.String" runat="server" Width="80px" MinValue="0" MaxValue="9999" MaxLength="4" Value="0" Culture="zh-TW" DbValueFactor="1" LabelCssClass="" LabelWidth="64px" meta:resourcekey="rNumCycleHoursResource1">
                            <NegativeStyle Resize="None" />
                            <NumberFormat ZeroPattern="n" AllowRounding="False" DecimalDigits="0"></NumberFormat>
                            <EmptyMessageStyle Resize="None" />
                            <ReadOnlyStyle Resize="None" />
                        ...
                        <asp:Label ID="Label26" runat="server" meta:resourcekey="Label3Resource1"
                            Text="時"></asp:Label>
                        <asp:Label ID="Label10" runat="server" Text="(0表示不提醒)" CssClass="SizeMemo" meta:resourcekey="Label10Resource1"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 25px" class="PopTableLeftTD">
        ...
        <telerik:RadPageView ID="RadPageViewPrintSetting" runat="server">
            <table cellspacing="1" class="PopTable" width="100%">
                ...
                <tr>
                    <td class="PopTableLeftTD">
                        <asp:Label ID="Label19" runat="server" Text="明細欄位列印" meta:resourcekey="Label19Resource1"></asp:Label>
                    </td>
