...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <style>
        .rblPrintDetailField input[type="radio"]
        {
            margin-left: 10px;
        }
    </style>
    ...
    <script type="text/javascript">
        ...
        function CheckPrintDefailFieldChoice(sender) {

            var cbAllowAllUserPrintDetailFieldWithVertical = $("#<%=cbAllowAllUserPrintDetailFieldWithVertical.ClientID%>");
            var cbAllowUserCustomPrintDetailFieldWithVertical = $("#<%=cbAllowUserCustomPrintDetailFieldWithVertical.ClientID%>");
            var divPrintDetailFieldWithVerticalDefaultDisplay = $(".divPrintDetailFieldWithVerticalDefaultDisplay");
            divPrintDetailFieldWithVerticalDefaultDisplay.css("display", "none");

            if (sender === undefined) {
                return;
            }

            var senderId = sender.id.length > 0 ? sender.id.split('_')[2] : '';

            switch (senderId) {
                case 'cbAllowAllUserPrintDetailFieldWithVertical':
                    if (cbAllowAllUserPrintDetailFieldWithVertical.is(":checked")) {
                        cbAllowUserCustomPrintDetailFieldWithVertical.prop("checked", false);
                        divPrintDetailFieldWithVerticalDefaultDisplay.css("display", "none");
                    }
                    break;

                case 'cbAllowUserCustomPrintDetailFieldWithVertical':
                    if (cbAllowUserCustomPrintDetailFieldWithVertical.is(":checked")) {
                        cbAllowAllUserPrintDetailFieldWithVertical.prop("checked", false);
                        divPrintDetailFieldWithVerticalDefaultDisplay.css("display", "");
                    }
                    else
                        divPrintDetailFieldWithVerticalDefaultDisplay.css("display", "none");
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" MultiPageID="RadMultiPage1"  CausesValidation="False" meta:resourcekey="RadTabStrip1Resource1" >
        <Tabs>
            <telerik:RadTab runat="server" Text="一般設定" Selected="True" meta:resourcekey="tabSetGenerallyResource1">
            </telerik:RadTab>
            ...
            <telerik:RadTab runat="server" Text="列印設定" meta:resourcekey="tabSetGenerallyResource7">
            </telerik:RadTab>
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" meta:resourcekey="RadMultiPage1Resource1">
            ...
            <table id="tbNormalSetting" class="PopTable" cellspacing="1" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadNumericTextBox ID="rntAutoSign" runat="server" Width="80px" MinValue="0" Value="0" DataType="System.String" Culture="zh-TW" DbValueFactor="1" LabelCssClass="" LabelWidth="64px" meta:resourcekey="rntAutoSignResource1">
                            ...
                            Text="時"></asp:Label>
                        <asp:Label ID="Label34" runat="server" Text="(0表示不設定)" CssClass="SizeMemo" meta:resourcekey="Label25Resource2"></asp:Label>
                    </td>
                ...
                <tr>
                    ...
                    <td  nowrap class="PopTableRightTD" colspan="3">
                        <telerik:RadNumericTextBox ID="rNumCycleHours" runat="server" Width="80px" MinValue="0" MaxValue="9999" MaxLength="4" Value="0" DataType="System.String" Culture="zh-TW" DbValueFactor="1" LabelCssClass="" LabelWidth="64px" meta:resourcekey="rNumCycleHoursResource1">
                            <NegativeStyle Resize="None" />
                            <NumberFormat ZeroPattern="n" AllowRounding="False" DecimalDigits="0"  ></NumberFormat>
                            <EmptyMessageStyle Resize="None" />
                            <ReadOnlyStyle Resize="None" />
                        ...
                        <asp:Label ID="Label29" runat="server" Text="(0表示不提醒)" CssClass="SizeMemo" meta:resourcekey="Label29Resource1"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="PopTableLeftTD">
                ...
                <tr>
                    ...
                    <td colspan="3" class="PopTableRightTD">
                        ...
                        <asp:Label ID="lblReturnSign" runat="server" ForeColor="Blue" meta:resourcekey="lblReturnSignResource1" Text="(勾選後，不論站點是否設定允許退簽，所有簽核人員都無法退簽表單)"></asp:Label>
                        <br />
            ...
            <table cellspacing="1" class="PopTable" width="100%">
                ...
                <tr>
                    ...
                    <td style="height: 30px;" class="PopTableRightTD">
                        ...
                        <br />
                        <asp:Label ID="lblInformMessage" runat="server" CssClass="SizeMemo"  style=" color: Blue" Text="備註： <br/> [表單結案通知]設定的人員一定會收到結案通知" meta:resourcekey="lblInformMessageResource1"></asp:Label>
        ...
        <telerik:RadPageView ID="RadPageViewPrintSetting" runat="server">
            <table cellspacing="1" class="PopTable" width="100%">
                <tr>
                    <td class="PopTableLeftTD">
                        <asp:Label ID="Label42" runat="server" Text="列印權限" meta:resourcekey="Label14Resource1"></asp:Label>
                    </td>
                    <td colspan="3" class="PopTableRightTD">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Label ID="Label44" runat="server" ForeColor="Blue"
                ...
                <tr>
                    <td class="PopTableLeftTD">
                        <asp:Label ID="Label46" runat="server" Text="明細欄位列印" meta:resourcekey="Label46Resource1"></asp:Label>
                    </td>
                    <td class="PopFlowTableRightTD" colspan="3">
                        <asp:CheckBox ID="cbAllowAllUserPrintDetailFieldWithVertical" runat="server" Text="所有人列印明細欄位資料時皆直向顯示" 
                            onclick="CheckPrintDefailFieldChoice(this)" meta:resourcekey="cbAllowAllUserPrintDetailFieldWithVerticalResource1" />
                        <asp:LinkButton ID="lbtnDetailFieldWithVerticalExample" runat="server" Text="(範例說明)" Font-Underline="true" ForeColor="Blue" meta:resourcekey="lbtnDetailFieldWithVerticalExampleResource1"></asp:LinkButton>
                        <br />
                        <asp:CheckBox ID="cbAllowUserCustomPrintDetailFieldWithVertical" runat="server" Text="允許使用者列印明細欄位資料時可自訂" 
                            onclick="CheckPrintDefailFieldChoice(this)" meta:resourcekey="cbAllowUserCustomPrintDetailFieldWithVerticalResource1" />
                        <br />
                        <table>
                            <tr>
                                <td>
                                    <div class="divPrintDetailFieldWithVerticalDefaultDisplay" style="margin-left:13.5px;">
                                        <asp:Label ID="lblPrintDetailFieldDefaultDisplay" runat="server" Text="預設顯示" meta:resourcekey="lblPrintDetailFieldDefaultDisplayResource1"></asp:Label>
                                    </div>
                                </td>
                                <td>
                                    <div class="divPrintDetailFieldWithVerticalDefaultDisplay">
                                        <asp:RadioButtonList ID="rboPrintDetailFieldWithVerticalDefaultDisplay" runat="server" CssClass="rblPrintDetailField" RepeatDirection="Horizontal" meta:resourcekey="rboPrintDetailFieldWithVerticalDefaultDisplayResource1">   
                                            <asp:ListItem meta:resourcekey="ListItemVerticalResource1" Value="Vertical" Text="直向" Selected="True" ></asp:ListItem>
                                            <asp:ListItem meta:resourcekey="ListItemHorizontalResource1" Value="Horizontal" Text="橫向"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        <asp:Label ID="lblPrintDetailFieldTip" runat="server" Text="(若設定將明細欄位資料直向顯示，則人員列印表單時，不提供自選列印明細子欄位)"
                            ForeColor="Blue" meta:resourcekey="lblPrintDetailFieldTipResource1"></asp:Label>
                    </td>
                </tr>
            </table>
        </telerik:RadPageView>
    ...
    <asp:Label ID="lblTestMsg500" runat="server" meta:resourcekey="lblTestMsg500Resource1" Text="呼叫Web Method錯誤" Visible="False"></asp:Label>
    <asp:Label ID="lblTestMsg401" runat="server" meta:resourcekey="lblTestMsg401Resource1" Text="無法認證通過" Visible="False"></asp:Label>
    <asp:Label ID="lblTestMsg404" runat="server" meta:resourcekey="lblTestMsg404Resource1" Text="無法呼叫asmx檔案" Visible="False"></asp:Label>
    <asp:Label ID="lblTestMsg99" runat="server" meta:resourcekey="lblTestMsg99Resource1" Text="無法連線Web Service主機" Visible="False"></asp:Label>
    <asp:Label ID="lblTestMsg" runat="server" meta:resourcekey="lblTestMsgResource1" Text="測試成功!!" Visible="False"></asp:Label>
    ...
    <asp:Label ID="Label10" runat="server" Text="沒有選擇WebService,請重新設定" Visible="False" meta:resourcekey="Label10Resource1"></asp:Label>
    ...
    <asp:Label ID="lblNonSetting" runat="server" Text="不設定" Visible="False" meta:resourcekey="lblNonSettingResource1"></asp:Label>
    <asp:Label ID="lblDetailFieldWithVerticalExampleDirections" runat="server" Text="明細欄位列印範例說明" Visible="false" meta:resourcekey="lblDetailFieldWithVerticalExampleDirectionsResource1"></asp:Label>
