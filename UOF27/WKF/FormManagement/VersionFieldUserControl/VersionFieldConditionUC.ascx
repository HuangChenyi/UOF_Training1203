...
<%@ Reference Control="~/WKF/FormManagement/VersionFieldUserControl/LinkedFieldUC.ascx" %>
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td valign="bottom">
            ...
            <asp:CustomValidator ID="CustomValidatorAbbreviation" runat="server" Display="Dynamic" ErrorMessage="簡稱不可多於50個字" meta:resourcekey="CustomValidator3Resource1"></asp:CustomValidator>
        </td>
    </tr>
</table>
...
<table cellspacing="1" class="PopTable" width="50%" id="TableNormal" runat="server" visible="true" enableviewstate="true">
    <tr>
        ...
        <td align="center" class="PopTableLeftTD" style="text-align: center; width: 40%">
            <asp:Label ID="Label5" runat="server" Text="比較資料" meta:resourcekey="Label5Resource1"></asp:Label>
        </td>
         <td align="center" class="PopTableLeftTD" style="text-align: center; width: 100%"  runat="server" id="tdlblAbbreviation">
            <asp:Label ID="Label6" runat="server" Text="簡稱" meta:resourcekey="lblAbbreviationResource1"></asp:Label>
        </td>
    </tr>
    <tr style="background-color: white">
        ...
        <td align="center" style="height: 40px; vertical-align: middle;" runat="server" id="tdTbxAbbreviation">
            <asp:TextBox ID="tbxAbbreviation" runat="server" Width="100%"></asp:TextBox>
        </td>
    </tr>
</table>
...
<table cellspacing="1" class="PopTable" width="100%" id="TableRange" runat="server" visible="false">
    <tr>
        ...
        <td style="width: 15%; height: 25px; text-align: center" class="PopTableLeftTD">
        ...
        <td align="center" class="PopTableLeftTD abberviation" style="text-align: center; width: 100%"  runat="server" id="tdlblAbbreviation2">
            <asp:Label ID="lblAbbreviation" runat="server" Text="簡稱" meta:resourcekey="lblAbbreviationResource1"></asp:Label>
        </td>
    </tr>
    <tr style="background-color: white">
        <td style="height: 40px; text-align: center; background-color: white; vertical-align: middle;">
        ...
        <td align="center" style="height: 40px; vertical-align: middle;" class="abberviation" id="tdTbxAbbreviation2">
            <asp:TextBox ID="tbxAbbreviation2" runat="server" Width="100%"></asp:TextBox>
        </td>
    </tr>
</table>
