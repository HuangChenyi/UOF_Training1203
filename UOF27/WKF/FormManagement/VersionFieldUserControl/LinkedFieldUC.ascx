<%@ Control Language="C#" AutoEventWireup="true" Inherits="WKF_FormManagement_VersionFieldUserControl_LinkedFieldUC" CodeBehind="LinkedFieldUC.ascx.cs" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td id="tdVisible" runat="server">
                                <telerik:RadDropDownList ID="rdlMain" runat="server" CssClass="DropDownLinked"></telerik:RadDropDownList>
                                <telerik:RadDropDownList ID="rdlSub" runat="server" CssClass="DropDownLinked"></telerik:RadDropDownList>
