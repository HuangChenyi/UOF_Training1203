...
<style>
    ...
    .tbDataGrid > tbody > tr td:first-child {
...
<asp:Panel ID="Panel1" runat="server" meta:resourcekey="Panel1Resource1" ScrollBars="None">
    <div runat="server" id="divField">
        <table cellpadding="0" cellspacing="0" style="width: 100%;">
            ...
            <tr id="trGrid" class="trDataGridHorizontal" runat="server">
                <td style="width: 100%;">
            ...
            <tr class="trDataGridVertical">
                <td>
                    <div id="divTableDataGrid" runat="server"></div>
                </td>
            </tr>
        </table>
    </div>
