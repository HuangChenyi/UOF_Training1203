...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td class="PopTableLeftTD">
                <font color="red">*</font>
                <asp:Label ID="lblTotalWidth" runat="server" Text="欄位寬度" meta:resourcekey="lblTotalWidthResource1"></asp:Label>
            </td>
            <td colspan="3" class="PopTableRightTD">
                ...
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" Text="px" meta:resourcekey="Label1Resource1"></asp:Label>
                <asp:Label ID="lblWidthTip" runat="server" ForeColor="Blue" Text="*0表示使用系統預設寬度550px，可自行設定寬度" meta:resourcekey="lblWidthTipResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="PopTableLeftTD">
