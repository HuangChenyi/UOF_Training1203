...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="PopTable">
        <tr>
            <td>
                <asp:Label Text="邏輯運算" runat="server" meta:resourcekey="lblLogicResource1"/>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label Text="簡稱" runat="server" meta:resourcekey="lblAbbreviationResource1"/>
            </td>
            <td>
                <asp:TextBox ID="tbxAbbreviation" runat="server" Width="50%" ></asp:TextBox>
                <asp:CustomValidator ID="CustomValidatortbxLength" runat="server" Display="Dynamic"
                    ErrorMessage="簡稱不可多於50個字" meta:resourcekey="CustomValidatortbxLengthResource1"></asp:CustomValidator>
            </td>
        </tr>
    </table>
    <table width="100%">
