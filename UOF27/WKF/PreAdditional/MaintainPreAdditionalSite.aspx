    ...
    <table class="PopTable" cellspacing="1" width="100%">
        <tbody>
            ...
            <tr>
                ...
                <td>&nbsp;
                    <telerik:RadNumericTextBox ID="rntCycleAlert" runat="server" Width="69px" MinValue="0" MaxValue="9999" MaxLength="4" Value="0" Culture="zh-TW" DbValueFactor="1" LabelWidth="27px" meta:resourcekey="rntCycleAlertResource1">
                        <NumberFormat ZeroPattern="n" AllowRounding="False" DecimalDigits="0"></NumberFormat>
                    </telerik:RadNumericTextBox>
