...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        function OnActionTypeSelectedChange() {
            ...
            switch (actionType) {
                case 'SEND':
                    ...
                    $(actionName).append($("<option></option>").val('MODIFY_SEND_DOC_DATE').html('變更發文日期'));
                    break;
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlActionName" Width="200px" runat="server">
                            ...
                            <asp:ListItem Text="變更發文日期" Value="MODIFY_SEND_DOC_DATE"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <%-- 關鍵字 --%>
    ...
    <asp:Label ID="lblModifySendDate" runat="server" Text="變更發文日期" Visible="false"></asp:Label>
