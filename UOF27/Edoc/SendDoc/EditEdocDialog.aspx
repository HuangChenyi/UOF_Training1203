...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
                ...
                $uof.dialog.open2("~/Edoc/SendDoc/ImportEdoc.aspx", args.get_item(), "", 380, 530, openDialogResult,
                    {
                        ...
                        "selectUserGUID": $('#<%=hfSelectUserGuid.ClientID%>').val()
                    });
            }
        }
        ...
        function SendUnitNameChange() {
            ...
            if ($("#<%=ddlSendUnitName.ClientID%> > option:selected").text() === '') { } else {
                ...
                var hfSelectUserId = $('#<%=hfSelectUserGuid.ClientID%>').val();
                var data = [hfFromUnitId, hfSelectUserId];
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Panel ID="pnlNumberString" runat="server">
                            ...
                            <br />
                            <asp:Label ID="lblEdocNumberGet" runat="server" ForeColor="Blue" Text="" ></asp:Label>
            ...
            <asp:HiddenField ID="hfPreviewFileGroupIdEndForm" runat="server" />
            <asp:HiddenField ID="hfActionType" runat="server" />
            <asp:HiddenField ID="hfUserGuid" runat="server" />
            <asp:HiddenField ID="hfSelectUserGuid" runat="server" />
            <asp:HiddenField ID="hfIsApplicant" runat="server" Value="false" />
            ...
            <asp:Label ID="lblEdocNumberGetStart" runat="server" Text="表單送出後由系統依發文機關及字號類別自動取號" Visible="false"></asp:Label>
            <asp:Label ID="lblEdocNumberGetEnd" runat="server" Text="表單核准結案後由系統依發文機關及字號類別自動取號" Visible="false"></asp:Label>
