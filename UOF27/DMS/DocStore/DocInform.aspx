...
<script src="../../Common/javascript/jQuery/plugin/jquery.qrcode.min.js" id="123"></script>
        ...
        function CatchError(key) {
            try {
                ...
                switch (key) {
                    ...
                    case "DocTempInactReturn":
                        if (window.confirm("<%=lblConfirmTempInactReturn.Text %>")) {
                            var inactDocData = [docID];
                            var inactResult = $uof.pageMethod.sync("TempInactRePublish", inactDocData);

                            if (inactResult == "true")
                                $(document).attr("location", $(document).attr("location"));
                            else
                                ShowError("<%=lblTempInactReturnError.Text %>", 360, 133);
                        }
                        break;
                                    ...
                                    <Items>
                                        <telerik:RadPanelItem Expanded="True" Text="作者功能" Enabled="False" Value="GrpAuthor" meta:resourcekey="RadPanelItemResource8">
                                            <Items>
                                                ...
                                                <telerik:RadPanelItem Text="取消暫時下架" Value="DocTempInactReturn" meta:resourcekey="RadPanelItemResource26" />
    ...
    <asp:Label ID="lblConfirmTempInactReturn" runat="server" Text="確定要將此文件前一公佈版本重新上架?" Visible="False" meta:resourcekey="lblConfirmTempInactRePublishResource1"></asp:Label>
    ...
    <asp:Label ID="lblTempInactReturnError" runat="server" Text="文件重新上架發生錯誤" Visible="False" meta:resourcekey="lblTempInactRePublishErrorResource1"></asp:Label>
