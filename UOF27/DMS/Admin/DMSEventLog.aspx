...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="PopTable" style="table-layout: fixed;">
                <tr>
                    ...
                    <td class="PopTableRightTD">
                        ...
                        <asp:CheckBox ID="chkSecurity" runat="server" Text="事件記錄" meta:resourcekey="chkSecurityResource1" />
                    </td>
    ...
    <asp:Label ID="lblEventLog" runat="server" Text="事件記錄" Visible="False" meta:resourcekey="lblEventLogResource1"></asp:Label>
