                                ...
                                <td>
                                    ...
                                    <tr>
                                        <td style="padding-left:20px">
                                            <asp:Label ID="lblTransparency" runat="server" Text="不透明度:" meta:resourcekey="lblTransparencyResource1" />
                                            <asp:DropDownList ID="ddlTransparency1" runat="server" meta:resourcekey="ddlTransparency1Resource1">
                                                ...
                                                <asp:ListItem meta:resourcekey="ListItemResource107">80</asp:ListItem>
                                                <asp:ListItem meta:resourcekey="ListItemResource108">90</asp:ListItem>
                                                <asp:ListItem meta:resourcekey="ListItemResource109" Selected="True">100</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
