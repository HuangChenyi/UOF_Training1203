...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="scriptblock1" type="text/javascript">
        ...
        function SetToolbarEnable(enable) {
            ...
            SetSingleSortButtonEnable(nodeTag,enable);
        }
        function SetSingleSortButtonEnable(folderID,enable) {
            ...
            var SingleSort = tb.findItemByValue("SingleSort");
            if (enable) {
                try {
                    var folderPrivilege;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <telerik:RadPane ID="TopRdPanel" runat="server" Height="35px" Scrolling="None" Index="0" meta:resourcekey="TopRdPanelResource1">
                    <telerik:RadToolBar ID="RadFolderToolbar1" runat="server" Width="100%" OnClientButtonClicking="RadFolderToolbar_Click" meta:resourcekey="barMainResource1" SingleClick="None" OnButtonClick="RadFolderToolbar1_ButtonClick">
                        <Items>
                            ...
                            <telerik:RadToolBarButton runat="server" CheckedImageUrl="~/Common/Images/Icon/icon_m193.png" DisabledImageUrl="~/Common/Images/Icon/icon_m193.png" HoveredImageUrl="~/Common/Images/Icon/icon_m193.png" ImageUrl="~/Common/Images/Icon/icon_m193.png" Text="全部重新排序" Value="Sort" meta:resourcekey="RadToolBarButtonResource1">
                            </telerik:RadToolBarButton>
                            <telerik:RadToolBarButton runat="server" IsSeparator="True"  meta:resourcekey="RadToolBarButtonResource3" />
                            <telerik:RadToolBarButton runat="server" CheckedImageUrl="~/Common/Images/Icon/icon_m257.png" DisabledImageUrl="~/Common/Images/Icon/icon_m257.png" HoveredImageUrl="~/Common/Images/Icon/icon_m257.png" ImageUrl="~/Common/Images/Icon/icon_m257.png" Text="單層目錄排序" Value="SingleSort" meta:resourcekey="RadToolBarButtonResource5">
                            </telerik:RadToolBarButton>
                            <telerik:RadToolBarButton runat="server" IsSeparator="True" meta:resourcekey="RadToolBarButtonResource3" />
                        </Items>
                    </telerik:RadToolBar>
            ...
            <asp:Label ID="lblMsg" runat="server" Text="全部目錄會依名稱排序，確定要排序?" Visible="False" meta:resourcekey="lblMsgResource1"></asp:Label>
            <asp:Label ID="lblSingleMsg" runat="server" Text="會對選取目錄下的第一階目錄(不含子目錄)來依名稱排序，確定要排序?" Visible="False" meta:resourcekey="lblSingleMsgResource1"></asp:Label>
    ...
    <telerik:RadScriptBlock runat="server" ID="scriptBlock">
        <script type="text/javascript">
            ...
            function RadFolderToolbar_Click(sender, args) {
                ...
                else if (button.get_value() == "SingleSort") {
                    if (confirm("<%=lblSingleMsg.Text%>")) {
                        var node = tree.get_selectedNode();
                        var data = [node.get_value()];
                        var result = $uof.pageMethod.sync("SortSingleFolder", data);
                        top.returnValue = "dopostback";
                    }
                    else {
                        args.set_cancel(true);
