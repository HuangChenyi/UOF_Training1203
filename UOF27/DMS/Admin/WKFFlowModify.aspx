...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
            <Fast:Grid runat="server" ID="gridChangeFolder" DefaultSortColumnName="FOLDER_NAME" DefaultSortDirection="Ascending" 
                AutoGenerateCheckBoxColumn="False" AllowSorting="True" AutoGenerateColumns="False"  DataKeyOnClientWithCheckBox="False" 
                EnhancePager="True" OnRowDataBound="gridChangeFolder_RowDataBound" OnSorting="gridChangeFolder_Sorting" PageSize="2" Width="100%">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FOLDER_ID" HeaderText="目錄代碼hidden">
                        <HeaderStyle CssClass="cssHidden" />
                        <ItemStyle CssClass="cssHidden" />
                    </asp:BoundField>
                                        
                    <asp:BoundField DataField="FOLDER_NAME" HeaderText="目錄名稱hidden">
                        <HeaderStyle CssClass="cssHidden" />
                        <ItemStyle CssClass="cssHidden" />
                    </asp:BoundField>
                                        
                    <asp:BoundField DataField="USE_TYPE" HeaderText="使用類別hidden">
                        <HeaderStyle CssClass="cssHidden" />
                        <ItemStyle CssClass="cssHidden" />
                    </asp:BoundField>
                </Columns>
